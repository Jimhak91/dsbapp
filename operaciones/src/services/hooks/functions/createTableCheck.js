export function createTableCheck(headers, dataFetch, table, nodos) {
    try {
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="${item.idRegistro}" id="flexCheckDefault${index}">
                    </div>
                <td>
            </tr>
        `;
